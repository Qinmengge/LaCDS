...
You can install the development version of LaCDS from [GitHub](https://github.com/Qinmengge/LaCDS) with:
...
ind: a integer vector of the event indicator taking values 0 and 1 with 0 corresponding to censoring and 1 corresponding to event.
X: a numeric matrix of the covariates of interest.
G: a integer scalar of the maximum number of subgroups to be fitted.
tol: a numeric scalar of the model convergence criteria defined as the l2 norm of covariate estimates between iterations.
